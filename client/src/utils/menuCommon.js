...
export default {
  MENU_LEVEL_ENUM, MENU_TYPE_ENUM, ENABLE_ENUM, MENU_SCOPE_ENUM, MENU_KIND_ENUM,
  MENU_VERIFY_ENUM, MENU_DISPLAY_ENUM, MENU_CHECKED_ENUM, WORKFLOW_ASSIGNEE_MODE_ENUM, MENU_ATTRIBUTE_ENUM
}

export function transferEnumObj2Arr(enumObj) {
